...
#cidade,habilitacao,cel,email
    ...
    # Combobox creation 
    n = tk.StringVar() 
    monthchoosen = ttk.Combobox(usuario, width = 27, textvariable = n) 
    ...
    btnSubmit= Button(usuario,text="submit",command=submit_usuario).grid(row=2,column=6,padx=5,pady=5)
